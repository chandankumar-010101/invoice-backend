    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Superuser'), (2, 'Admin'), (3, 'Sales manager'), (4, 'Accountant'), (5, 'Customer support'), (6, 'Others')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annual_turnover', models.CharField(blank=True, max_length=255, null=True)),
                ('accounting_software', models.CharField(blank=True, max_length=255, null=True)),
                ('estimate_invoice_issue', models.CharField(blank=True, max_length=255, null=True)),
